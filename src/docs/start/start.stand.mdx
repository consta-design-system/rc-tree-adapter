Этот адаптер стилизует дерево из библиотеки [rc-tree](https://github.com/react-component/tree) для дизайн-системы Consta.
...
Тему обязательно нужно подключать в корне приложения, так, чтобы все компоненты `@consta/rc-tree-adapter` были вложены в компонент [`Theme`](##LIBS.LIB.STAND/lib:uikit/stand:components-theme-stable).
